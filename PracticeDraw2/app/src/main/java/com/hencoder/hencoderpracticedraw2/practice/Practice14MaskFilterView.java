...
public class Practice14MaskFilterView extends View {
    ...
    Bitmap bitmap;
    MaskFilter maskFilter1 = new BlurMaskFilter(60, BlurMaskFilter.Blur.NORMAL);
    MaskFilter maskFilter2 = new BlurMaskFilter(60, BlurMaskFilter.Blur.INNER);
    MaskFilter maskFilter3 = new BlurMaskFilter(60, BlurMaskFilter.Blur.OUTER);
    MaskFilter maskFilter4 = new BlurMaskFilter(60, BlurMaskFilter.Blur.SOLID);
