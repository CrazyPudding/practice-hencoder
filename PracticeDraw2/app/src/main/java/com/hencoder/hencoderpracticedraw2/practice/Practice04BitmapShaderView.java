...
public class Practice04BitmapShaderView extends View {
...

    {
        ...
        paint.setShader(new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman), Shader.TileMode.CLAMP, Shader.TileMode.MIRROR));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(200, 200, 400, paint);
    }
}
